...
const Login = () => {
    ...
    return (
        <div className='flex lg:h-screen lg:m-0 m-4 justify-center items-center bg-slate-300'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body items-center ">
                    ...
                    <form className='w-full' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {signInError}
                        <input type="submit" className='btn bg-green-600 border-0 w-full mt-4 text-white' value='Login' />
                    </form>
                    <p className='text-sm pt-2'>New to Ucoders? <Link className='text-sky-500' to='/signup'>Create new account</Link></p>
