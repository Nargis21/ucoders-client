...
const AddReact = () => {
    const handleAddReactContent = event => {
        ...
        fetch('https://ucoders-server.vercel.app/reactLessons', {
            ...
            body: JSON.stringify(reactContent)
        })
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className='flex justify-center items-center my-6 lg:mx-0 mx-4'>
            <div class="card pr-8 lg:w-3/5 shadow-xl text-center bg-slate-300">
                <h1 className='text-3xl text-slate-700 my-4 font-bold'>Add a New React Lesson</h1>
                <form onSubmit={handleAddReactContent} className='text-center'>
